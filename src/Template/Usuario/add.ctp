...
<div>
    ...
    <fieldset>
        ...
        <table>
    <tr>
          <td> <?php echo $this->Form->control('cedula',array('label' =>'Cédula','type'=>'text','minlength'=>'9','maxlength'=>'9', 'onkeypress'=>'return validaN(event)','placeholder' => "Ingrese solo números")); ?> </td>
