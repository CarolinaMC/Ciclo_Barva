...
class BicicletaFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tamano' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'color' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'bicicleta_ibfk_1' => ['type' => 'foreign', 'columns' => ['cliente_id'], 'references' => ['cliente', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'bicicleta_ibfk_2' => ['type' => 'foreign', 'columns' => ['marca_id'], 'references' => ['marca', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
